  ...
  if(vki<=18.5)
      {
          ...
          System.out.println(df.format(18.5Math.pow(boy/100,2)-kilo)+" Kilogram almanız gerekiyor");
   ...
   else if(vki<=29.9)
     {
       ...
       System.out.println(df.format(kilo-24.9Math.pow(boy/100,2))+" Kilogram vermeniz gerekiyor");
     }
